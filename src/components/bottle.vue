...
// Совместимость
const metalResults = {
  // Удачные (как у вас — всё правильно)
  "Золото-Серебро": {
    success: true,
    name: "Электрум",
  ...
  "Алюминий-Медь": {
    ...
    name: "Дюралюминий",
    usage: "Авиастроение.",
    features: "Лёгкий и прочный при строгом соблюдении технологии.",
  },
  "Железо-Углерод": {
    success: true,
    name: "Сталь",
  ...
  // Частично удачные (научно корректные)
  "Никель-Алюминий": {
    success: false,
    description: "Образует интерметаллиды.",
    inefficiency: "Очень прочный, но хрупкий при комнатной температуре.",
  },
  "Железо-Медь": {
    success: false,
    description: "Плохая взаимная растворимость.",
    inefficiency: "Риск расслоения без специальных технологий.",
  },
  "Платина-Алюминий": {
    success: false,
    description: "Формируются хрупкие фазы.",
    inefficiency: "Нужен контроль состава и температуры, иначе трещины.",
  },

  // Полностью неудачные (оставил как есть — корректно)
  "Золото-Железо": {
    success: false,
    description: "Хрупкие интерметаллиды.",
    inefficiency: "Соединение быстро разрушается.",
  },
  "Серебро-Железо": {
    success: false,
    description: "Не образуют устойчивый сплав.",
    inefficiency: "Сильная коррозия.",
  },
  "Медь-Алюминий": {
    success: false,
    description: "Гальваническая коррозия при неправильной технологии.",
    inefficiency: "Разрушается при нагреве и контакте с электролитами.",
  },
  "Золото-Медь": {
    success: true,
    name: "Красное золото",
    usage: "Ювелирные украшения, декоративные элементы.",
    features:
      "Твёрже чистого золота, устойчиво к коррозии, имеет насыщенный тёплый оттенок.",
  },
};
...
const leftColor = computed(() =>
  leftMetal.value ? metals[leftMetal.value] : null
);
const rightColor = computed(() =>
  rightMetal.value ? metals[rightMetal.value] : null
);
</script>
...
<template>
  <div class="bottle-animation">
    ...
    <div class="animation-control">
      <button @click="startMix" :disabled="!leftColor || !rightColor">
        Старт
      </button>
...
.bottle {
  ...
  box-shadow: inset 0 0 15px rgba(255, 255, 255, 0.18),
    inset 0 0 30px rgba(255, 255, 255, 0.08), 0 8px 25px rgba(0, 0, 0, 0.25);
  overflow: hidden;
